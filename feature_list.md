...
| App icons | done | the DelayBahn DB logo (boxed monogram, clock in the D) in solid white on the brand-red tile — derived from `logo.png` (monogram cropped above the wordmark, its semi-transparent ink thresholded to a solid mask, painted white; 4× supersample + LANCZOS): 192/512 in `any` and `maskable`, plus a 180 px apple-touch, in `static/icons/` (2026-08-11; replaced the initial placeholder train mark) |
