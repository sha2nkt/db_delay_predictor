...
| Per-day delay chart | done | per-day breakdown behind the delay badges (added 2026-07-15); clickable badges show a ▾ disclosure caret (rotates while open) + mobile tap-target/press feedback after user feedback that the feature was undiscoverable (2026-08-02, Playwright-verified) |
